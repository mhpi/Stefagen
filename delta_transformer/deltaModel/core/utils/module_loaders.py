...
def get_data_loader(loader_name: str, holdout_index=None) -> Type:
    """
    ...
    holdout_index : int, optional
        The index of holdout to use for spatial testing.

    Returns
    -------
    Type
        The uninstantiated data loader class or an instantiated loader object
        if holdout_index is provided.
    """

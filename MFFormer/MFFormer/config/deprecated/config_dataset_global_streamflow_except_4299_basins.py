...
tmp = {
    'input_nc_file': os.path.join(server_dir, 'format_data/26.pretrain_data_processing/01.insitu_and_basin_average/08.GLOBAL_STREAMFLOW_HYLKE/GLOBAL_4299_except.nc'),
    'train_date_list': ["1999-01-01", "2016-12-31"],
    'val_date_list': ["1998-01-01", "1998-12-31"],
    'test_date_list': ["1980-01-01", "1997-12-31"],

    'time_series_variables': ["P", "PET", "Tmax", "Tmin", ], #"Wind"
    'target_variables': [],
...
config_dataset_global_except_4299 = SimpleNamespace(**tmp)

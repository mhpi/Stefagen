...
tmp = {
    'input_nc_file': os.path.join(server_dir,
                                  '/data/jql6620/local/30.MFFormer/examples/09.do_it_from_scratch/output/4D_contour_Australia_204046.nc'),
    ...
    'group_mask_dict': {
        ...
        'geology': ['Permeability_no_permafrost', 'carbonate_sedimentary_rocks_frac', 'soil_depth', 'porosity'],
...
config_dataset_4D_contour_Australia_204046 = SimpleNamespace(**tmp)

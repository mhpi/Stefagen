...
tmp = {
    'input_nc_file': os.path.join(server_dir,
                                  'format_data/26.pretrain_data_processing/01.insitu_and_basin_average/12.Hylke_20000_basins/GLOBAL_19999.nc'),
...
config_dataset_global_20000 = SimpleNamespace(**tmp)

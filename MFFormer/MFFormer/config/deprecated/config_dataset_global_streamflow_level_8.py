...
tmp = {
    'input_nc_file': os.path.join(server_dir, 'format_data/26.pretrain_data_processing/01.insitu_and_basin_average/10.HydroBasin/GLOBAL_level_8.nc'),
...
config_dataset_global_level_8 = SimpleNamespace(**tmp)

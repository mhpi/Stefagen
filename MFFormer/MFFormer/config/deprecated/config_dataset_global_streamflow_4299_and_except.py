...
tmp = {
    'input_nc_file': os.path.join(server_dir,
                                  'format_data/26.pretrain_data_processing/01.insitu_and_basin_average/08.GLOBAL_STREAMFLOW_HYLKE/GLOBAL_4299_and_except.nc'),
...
config_dataset_global_4299_and_except = SimpleNamespace(**tmp)

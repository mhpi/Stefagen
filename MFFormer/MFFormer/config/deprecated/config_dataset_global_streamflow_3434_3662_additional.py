...
tmp = {
    'input_nc_file': os.path.join(server_dir,
                                  'format_data/26.pretrain_data_processing/01.insitu_and_basin_average/01.Hylke_global_streamflow/GLOBAL_3434_3262_HydroBasin_selection.nc'),
...
config_dataset_global_3434_3262_additional = SimpleNamespace(**tmp)

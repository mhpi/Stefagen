...
tmp = {
    'input_nc_file': os.path.join(server_dir, 'format_data/26.pretrain_data_processing/01.insitu_and_basin_average/01.Hylke_global_streamflow/GLOBAL_4229_ERA5.nc'),
...
config_dataset_global_4299_ERA5 = SimpleNamespace(**tmp)
